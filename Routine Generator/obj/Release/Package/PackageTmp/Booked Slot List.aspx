<%@ Page Title="Booked Slot" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Booked Slot List.aspx.cs" Inherits="Routine_Generator.Booked_Slot_List" %>
    ...
    <script type="text/javascript">
        function onClickbtn() {
            ...
            html2canvas(document.querySelector("#ContentPlaceHolder1_GridViewWeekDay")).then(canvas => {
                ...
                download(canvas.toDataURL("image/jpeg"), 'Booked List of ' + title, 'image/jpeg')
                            ...
                            <table class="table  table-bordered  table-responsive">
                                <tr>
                                    <td class="text-center" style="background-color: black; color: white; width: 100%">
                                        <strong>
                                            <asp:Label ID="LabelHeader" runat="server" Text="Booked Slot" Style="font-size: 25px"></asp:Label>
                                        </strong>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <table class="table  table-bordered  table-responsive">
                                    <tr>
                                        <td class="text-center" style="background-color: antiquewhite; width: 100%">
                                            <strong>
                                                <asp:Label ID="LabelDistinctDates" runat="server" Text='<%# Eval("Dates") %>' Style="font-size: 25px"></asp:Label>
                                            </strong>
                                        </td>
                                    </tr>
                                </table>
                                                ...
                                                <table class="table  table-bordered  table-responsive">
                                                    <tr>
                                                        <td style="background-color: beige; text-align: center; width: 40%; font-weight: bold; font-size: 18px">
                                                            <asp:Label ID="LabelCourseCode" runat="server" Text='<%# Eval("Course").ToString().Replace(" ", "") %>'></asp:Label>
                                                            <br />
                                                            <asp:Label ID="LabelCourse" runat="server" Text='<%# GetCourseName((string)Eval("Course")) %>' CssClass="auto-style1" Font-Bold="False"></asp:Label>
                                                        </td>
                                                        <td style="background-color: beige; text-align: center; width: 15%; font-weight: bold; font-size: 18px">
                                                            <asp:Label ID="LabelTeacherInitial" runat="server" Text='<%# Eval("Teacher").ToString().Replace(" ", "") %>'></asp:Label>
                                                            <br />
                                                            <asp:Label ID="LabelTeacher" runat="server" Text='<%# getTeacherName((string)Eval("Teacher")) %>' CssClass="auto-style1" Font-Bold="False"></asp:Label>
                                                        </td>
                        ...
                        <HeaderTemplate>
                            <table class="table  table-bordered  table-responsive">
                                <tr>
                                    <td class="text-center" style="background-color: black; color: white; width: 100%">
                                        <strong>
                                            <asp:Label ID="LabelHeaderMin" runat="server" Text="Booked Slot" Style="font-size: 25px"></asp:Label>
                                        </strong>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="width: 100%;">
                                <table class="table  table-bordered  table-responsive">
                                    <tr>
                                        <td class="text-center" style="background-color: antiquewhite; width: 100%">
                                            <strong>
                                                <asp:Label ID="LabelDistinctDates" runat="server" Text='<%# Eval("Dates") %>' Style="font-size: 40px; font-weight: 900"></asp:Label>
                                            </strong>
                                        </td>
                                    </tr>
                                </table>
